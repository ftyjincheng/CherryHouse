	...
	<view>
		<view class="container">
			...
			<view class="content">
				...
				<view class="info ma">想租多大的房子？</view>
				...
				<view class="info ma">租房预算是多少？</view>
				...
				<!-- <slider selected-color="#32BDB5" @change="change1" step="1" min="1" max="7" ></slider>
			<view class="price">
				<text>0</text>
				<text>1千</text>
				<text>2千</text>
				...
				<view class="search">
					<input type="number" :value="budget" placeholder="请填写您的预算"></input>元
				</view>
